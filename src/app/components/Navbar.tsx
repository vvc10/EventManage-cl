...
interface NavbarProps {
    about?: string; // Optional prop, or use `about: string` if required
}

const Navbar: React.FC<NavbarProps> = ({ about }) => {
    ...
    return (
        <>
            <div className={`${about === "ABOUT" ? "navbar relative top-0 bg-white text-black z-10 flex flex-col md:flex-row items-center justify-between py-4 px-4 md:py-6 md:px-6" : "navbar sticky top-0 bg-white text-black z-10 flex flex-col md:flex-row items-center justify-between py-4 px-4 md:py-6 md:px-6"}`}>
                {/* Brand Section */}
